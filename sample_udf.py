...
def convert_udf_grid(arg):
    ...
    save_path = mesh_path.replace('mesh2point', 'udf')
    if not os.path.exists(save_path):
        os.makedirs(save_path)
    np.save(os.path.join(save_path, mesh_name[:-4] + '.npy'), u)
...
if __name__ == '__main__':
    ...
    pattern = "*.ply"
    root = '/home/ubuntu/public_c/cxy/data/point'
